...
class EtapePresentation(SceneParadoxe):
    ...
    def dessiner_contenu(self, ecran):
        ...
        citation = ("« À chaque instant, la flèche est immobile;"
                    "donc le mouvement n'existe pas »")
        contexte = ("Le temps semble composé d'instants. \n"
                "Or pendant UN instant, la flèche est simplement là,"
                "dans une position fixe. \n"
                "Zénon conclut : une somme d'immobilités ne peut pas"
                "donner un mouvement")
